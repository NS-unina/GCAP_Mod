/* Attack goal */
attackGoal(canTamper(controlFlow2)).
...
trafficVisibility(gpsModule,autopilot).
trafficVisibility(gpsModule,radiocontroller).
...
controlFlow(radiocontroller, autopilot, controlFlow2).

applicationLayer(msp, radiocontroller, autopilot).
weaknessApplicationLayer(ds2, radiocontroller, autopilot, msp).
