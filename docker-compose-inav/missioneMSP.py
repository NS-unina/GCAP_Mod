...
def main():
    parser = argparse.ArgumentParser(description="Invia coordinate GPS tramite protocollo MSP.")
    ...
    parser.add_argument("--file", type=str, help="File contenente le coordinate")
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        with open(args.file, 'r') as file:
            for line in file:
                ...
                print(f"Mando coordinate: {lat}, {lon}")
